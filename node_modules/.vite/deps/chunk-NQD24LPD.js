...
function useToast(props) {
  ...
  (0, import_react.useEffect)(function() {
    ...
    return function() {
      if (isFn(syncProps.onClose)) syncProps.onClose((0, import_react.isValidElement)(syncProps.children) && syncProps.children.props);
    };
  }, []);
  (0, import_react.useEffect)(function() {
...
var Toast = function Toast2(props) {
  ...
  return (0, import_react.createElement)(Transition, {
    ...
    style: bodyStyle
  }), children), renderCloseButton(closeButton), (autoClose || isProgressControlled) && (0, import_react.createElement)(ProgressBar, Object.assign({}, updateId && !isProgressControlled ? {
    key: "pb-" + updateId
  } : {}, {
    rtl,
    delay: autoClose,
...
//# sourceMappingURL=chunk-NQD24LPD.js.map
